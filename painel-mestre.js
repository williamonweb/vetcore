...
Equipe VetCore.`;
  ...
  function adminMasterPermitido() {
    ...
    return email === "williamgomes990@gmail.com";
  }
  ...
  function editarUnidadeClientePainel(clienteId, chave) {
    garantirAuthMaster(() => {
      ...
      const novoNome = prompt("Novo nome da unidade:", atual);
  ...
  function excluirUnidadeClientePainel(clienteId, chave) {
    garantirAuthMaster(() => {
      ...
      if (!confirm("Excluir esta unidade do cliente?")) return;
  ...
  function excluirClientePainelMestre(id) {
    garantirAuthMaster(() => {
      const cliente = obterClientePorId(id);
      if (!cliente) return;
      if (!confirm(`Excluir ${cliente.nomeClinica}?`)) return;
    ...
    window.fazerLogin = function () {
      ...
      setTimeout(function () {
        ...
        try {
          ...
          if (adminMasterPermitido() && ["williamgomes990@gmail.com"].includes(usuario)) {
